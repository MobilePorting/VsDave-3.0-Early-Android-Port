...
class CreditsMenuState extends MusicBeatState
{
	...
	var peopleInCredits:Array<Person> = [
		...
		new Person("BombasticHype", CreditsType.Contributor, "Did cutscenes", [new Social('youtube', 'https://www.youtube.com/c/BombasticHype')]),
		...
		new Person("peejeada", CreditsType.BetaTester, "Beta Tester & Supporter", [new Social('twitter', 'https://twitter.com/tailsmaster1')]),
		new Person("Aadsta", CreditsType.BetaTester, "Beta Tester & Supporter", [new Social('twitter', 'https://twitter.com/FullNameDeTrain')]),
		...
		new Person("weednose", CreditsType.BetaTester, "Beta Tester", [new Social('twitter', 'https://twitter.com/GucciWallece')]),
		new Person("vex", CreditsType.BetaTester, "Beta Tester", [new Social('twitter', 'https://twitter.com/vex________')]),
		...
		new Person("mantis", CreditsType.BetaTester, "Beta Tester", [new Social('discord', 'mantis#6969')]),
		new Person("ArturSef", CreditsType.BetaTester, "Beta Tester", [new Social('gamebanana', 'https://gamebanana.com/members/1766076')]),
		...
		new Person("Rendurse", CreditsType.BetaTester, "Beta Tester", [new Social('twitter', 'https://twitter.com/RendurseDev')]),
		...
		new Person("Villezen", CreditsType.BetaTester, "Beta Tester & Supporter", [new Social('youtube', 'https://www.youtube.com/c/Villezen')]),
